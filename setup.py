...
# 这些变量需要自行填写值
DESCRIPTION = 'bert ner'  # string example: description="this is a python package"
KEYWORDS = ("bert", "sequence labeling", "deploy")  # string of tuple example: keywords=("test","python_package")
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'bert-ner-train = bert_ner_cli.train:main',
        ],
    },
)
